    ...
    <div>
      <div className="my-4 stats inline-grid md:flex  shadow stats-vertical   md:stats-horizontal">
        ...
        <div className="stat">
          ...
          <div className="stat-value text-teal-600">{summary.ordersCount}</div>
          <div className="stat-desc">
        ...
        <div className="stat">
          ...
          <div className="stat-value text-teal-600">{summary.productsCount}</div>
          <div className="stat-desc">
        ...
        <div className="stat">
          ...
          <div className="stat-value text-teal-600">{summary.usersCount}</div>
          <div className="stat-desc">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div>
          ...
          <div className="flex items-center justify-center h-80 w-96 mb-10">
